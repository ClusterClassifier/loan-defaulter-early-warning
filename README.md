...
**Berka Dataset (PKDD'99 Financial Dataset)**
The only publicly available dataset containing real, anonymised transaction history and loan records for the same bank customers — sourced from a Czech bank covering 1993–1998.
